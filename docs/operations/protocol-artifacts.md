...
- a manifest with Briosa version, source revision, exact SA target, protocol packages, source fingerprint, descriptor fingerprint, and file hashes; and
...
A Briosa release may add or change an operation only through the normal protobuf compatibility policy and the handwritten vertical-slice review described by [ADR 0024](../architecture/0024-handwritten-mp-operation-vertical-slices.md).
