...
- `conformance/v1/`: vertical-slice, Wave 1 read-only, Wave 2 point-lifecycle, Wave 2 collection-mutation, Wave 2 object-lifecycle, and Wave 2 note-mutation packaged-host scenarios plus typed-error/replay cases;
