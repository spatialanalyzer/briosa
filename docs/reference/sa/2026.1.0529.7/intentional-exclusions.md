...
Briosa intentionally excludes 350 of the 1,412 inventoried SpatialAnalyzer commands under the product-scope review recorded in issue #52 and later focused decisions. These commands are accounted for, but they are not supported candidates and will not appear in capability discovery or generated public RPCs.
...
| `client_owned_value_construction` | 65 | Briosa client types and client-language collections replace primitive constructors, reference-list algebra, indexing, and decomposition helpers. |
