...
internal static partial class ConstructionWaveBOperationCatalog
{
    ...
    [
        ...
        Mutating(
            ...
            [
                new("object_type", "Object Type", WorkerMpValueKind.Text, "SetStringArg", "Required", true, EnumTextValues: ["Any", "Circles", "Cones", "Cylinders", "Lines", "Planes", "Slots", "Spheres", "Center Points", "Surface Points", "Vertex Points"]),
                new("point_offset", "Point Offset", WorkerMpValueKind.FloatingPoint, "SetDoubleArg", "0", false)
            ]),
        Mutating(
