...
internal static class InstrumentWaveBOperationCatalog
{
    ...
    [
        ...
        Mutating(
            ...
            [
                new("instrument", "Instrument to scan", WorkerMpValueKind.CollectionInstrumentId, "SetColInstIdArg", "Required", true),
                new("scan_perimeters", "Scan perimeter list", WorkerMpValueKind.CollectionObjectNameList, "SetCollectionObjectNameRefListArg", "Required", true),
                new("exclusion_perimeters", "Exclusion perimeter list", WorkerMpValueKind.CollectionObjectNameList, "SetCollectionObjectNameRefListArg", "Required", true),
                new("parameter_set_name", "Parameter set name", WorkerMpValueKind.Text, "SetStringArg", "Empty", false),
                new("profile_name", "Profile name", WorkerMpValueKind.Text, "SetStringArg", "Empty", false),
                new("clear_profile", "Clear Profile?", WorkerMpValueKind.Logical, "SetBoolArg", "true", false),
                new("create_new_profile", "Create New Profile?", WorkerMpValueKind.Logical, "SetBoolArg", "false", false)]),
        Mutating(
        ...
        ReadOnly(
            ...
            [],
            [
                new("verification_enabled", "Verification Enabled?", WorkerMpValueKind.Logical, "GetBoolArg", "—", false)]),
        ReadOnly(
        ...
        ReadOnly(
            ...
            [
                new("instrument", "Instrument ID", WorkerMpValueKind.CollectionInstrumentId, "SetColInstIdArg", "Required", true)],
            [
                new("point", "Point Name", WorkerMpValueKind.PointName, "GetPointNameArg", "—", false)]),
        ReadOnly(
        ...
        ReadOnly(
            ...
            [
                new("mode_profile", "Mode/Profile", WorkerMpValueKind.Text, "GetStringArg", "—", false)]),
        ReadOnly(
        ...
        ReadOnly(
            ...
            [
                new("instrument", "Instrument ID", WorkerMpValueKind.CollectionInstrumentId, "SetColInstIdArg", "Required", true)],
            [
                new("targeting_name", "Targeting Name", WorkerMpValueKind.Text, "GetStringArg", "—", false)]),
        ReadOnly(
            ...
            [
                new("instrument", "Instrument to get", WorkerMpValueKind.CollectionInstrumentId, "SetColInstIdArg", "Required", true)],
            [
        ...
        Mutating(
            ...
            [
                ...
                new("parameter_set_name", "Parameter set name", WorkerMpValueKind.Text, "SetStringArg", "Empty", false),
                new("enable_exclusions", "Enable exclusions?", WorkerMpValueKind.Logical, "SetBoolArg", "true", false),
                new("wait_for_completion", "Wait for Completion", WorkerMpValueKind.Logical, "SetBoolArg", "true", false)]),
        Mutating(
        ...
        Mutating(
            ...
            [
                new("verification_enabled", "Enable Verification?", WorkerMpValueKind.Logical, "SetBoolArg", "false", false)]),
        Mutating(
        ...
        Mutating(
            ...
            [
                new("instrument", "Instrument ID", WorkerMpValueKind.CollectionInstrumentId, "SetColInstIdArg", "Required", true),
                new("sample_time_milliseconds", "Sample Time MS (1-2000)", WorkerMpValueKind.WholeNumber, "SetIntegerArg", "0", false)]),
        Mutating(
            ...
            [
                new("instrument", "Instrument ID", WorkerMpValueKind.CollectionInstrumentId, "SetColInstIdArg", "Required", true),
                new("sphere_radius", "Sphere Radius", WorkerMpValueKind.FloatingPoint, "SetDoubleArg", "1.187500", false),
                new("scan_line_spacing", "Scan Line Spacing", WorkerMpValueKind.FloatingPoint, "SetDoubleArg", "0.050000", false),
                new("send_center_point", "Send Center Point?", WorkerMpValueKind.Logical, "SetBoolArg", "true", false),
                new("send_sphere", "Send Sphere?", WorkerMpValueKind.Logical, "SetBoolArg", "false", false),
                new("send_measured_cloud", "Send Measured Cloud?", WorkerMpValueKind.Logical, "SetBoolArg", "false", false)]),
        Mutating(
            ...
            [
                new("instrument", "Instrument ID", WorkerMpValueKind.CollectionInstrumentId, "SetColInstIdArg", "Required", true),
                new("scan_line_spacing", "Scan Line Spacing", WorkerMpValueKind.FloatingPoint, "SetDoubleArg", "0.050000", false),
                new("width_of_extra_area_around_scan", "Width of Extra Area Around Scan", WorkerMpValueKind.FloatingPoint, "SetDoubleArg", "0.000000", false)]),
        Mutating(
