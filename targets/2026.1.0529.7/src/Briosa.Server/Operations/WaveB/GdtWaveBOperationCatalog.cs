...
internal static class GdtWaveBOperationCatalog
{
    ...
    [
        ...
        ReadOnly(
            ...
            [],
            [
                new("use_extended_options", "Use Extended Options", WorkerMpValueKind.Logical, "GetBoolArg", "—", false)]),
        ReadOnly(
        ...
        Mutating(
            ...
            [
                ...
                new("per_unit_length_distance", "Per unit (area) length distance", WorkerMpValueKind.FloatingPoint, "SetDoubleArg", "0.000000", false),
                new("per_unit_length_step_over_percent", "Per unit (area) length step over %", WorkerMpValueKind.FloatingPoint, "SetDoubleArg", "50.000000", false),
        ...
        Mutating(
            ...
            [
                new("use_extended_options", "Use Extended Options", WorkerMpValueKind.Logical, "SetBoolArg", "true", false),
                new("circle_extended_options", "Circle Extended Options", WorkerMpValueKind.Text, "SetStringArg", "Least Squares", false, null, ["Least Squares", "High Point", "Minimum Separation", "Least Squares High Point", "Least Squares 3D", "Least Squares High Point 1 STD DEV", "Least Squares High Point 2 STD DEV", "Least Squares High Point Halfway", "", "", ""]),
                new("cone_extended_options", "Cone Extended Options", WorkerMpValueKind.Text, "SetStringArg", "Least Squares", false, null, ["Least Squares", "", "Minimum Separation", "Least Squares High Point", "", "Least Squares High Point 1 STD DEV", "Least Squares High Point 2 STD DEV", "Least Squares High Point Halfway", "", "", ""]),
                new("cylinder_extended_options", "Cylinder Extended Options", WorkerMpValueKind.Text, "SetStringArg", "Least Squares", false, null, ["Least Squares", "High Point", "Minimum Separation", "Least Squares High Point", "", "Least Squares High Point 1 STD DEV", "Least Squares High Point 2 STD DEV", "Least Squares High Point Halfway", "", "", ""]),
                new("ellipse_extended_options", "Ellipse Extended Options", WorkerMpValueKind.Text, "SetStringArg", "Least Squares", false, null, ["Least Squares", "High Point", "Minimum Separation", "Least Squares High Point", "", "Least Squares High Point 1 STD DEV", "Least Squares High Point 2 STD DEV", "Least Squares High Point Halfway", "", "", ""]),
                new("line_extended_options", "Line Extended Options", WorkerMpValueKind.Text, "SetStringArg", "Least Squares", false, null, ["Least Squares", "", "Minimum Separation", "", "", "", "", "", "", "", ""]),
                new("open_slot_extended_options", "Open Slot Extended Options", WorkerMpValueKind.Text, "SetStringArg", "Least Squares", false, null, ["Least Squares", "High Point", "", "Least Squares High Point", "", "Least Squares High Point 1 STD DEV", "Least Squares High Point 2 STD DEV", "Least Squares High Point Halfway", "", "", ""]),
                new("plane_extended_options", "Plane Extended Options", WorkerMpValueKind.Text, "SetStringArg", "Least Squares", false, null, ["Least Squares", "High Point", "Minimum Separation", "Least Squares High Point", "", "Least Squares High Point 1 STD DEV", "Least Squares High Point 2 STD DEV", "Least Squares High Point Halfway", "Minimum Separation High Point", "Equalized High Point", "Equalized LSQ High Point"]),
                new("slot_extended_options", "Slot Extended Options", WorkerMpValueKind.Text, "SetStringArg", "Least Squares", false, null, ["Least Squares", "High Point", "Minimum Separation", "Least Squares High Point", "", "Least Squares High Point 1 STD DEV", "Least Squares High Point 2 STD DEV", "Least Squares High Point Halfway", "", "", ""]),
                new("sphere_extended_options", "Sphere Extended Options", WorkerMpValueKind.Text, "SetStringArg", "Least Squares", false, null, ["Least Squares", "High Point", "Minimum Separation", "Least Squares High Point", "", "Least Squares High Point 1 STD DEV", "Least Squares High Point 2 STD DEV", "Least Squares High Point Halfway", "", "", ""])]),
        Mutating(
        ...
        ReadOnly(
            ...
            [
                ...
                new("options", "Only Create Failed Vectors?", WorkerMpValueKind.Logical, "GetBoolArg", "—", false, NestedFieldName: "only_create_failed_vectors"),
        ...
        Mutating(
            ...
            [
                ...
                new("only_create_failed_vectors", "Only Create Failed Vectors?", WorkerMpValueKind.Logical, "SetBoolArg", "false", false),
