    ...
    : Api.GdtOperations.GdtOperationsBase
{
    ...
    [OperationImplementation("gdt_operations.set_gdt_extended_options")]
    public override Task<Api.SetGdtExtendedOptionsResult> SetGdtExtendedOptions(Api.SetGdtExtendedOptionsRequest request, ServerCallContext context) =>
        MpOperationServiceExecutor.ExecuteAsync<Api.SetGdtExtendedOptionsRequest, Api.SetGdtExtendedOptionsResult>(executor, request, context, "gdt_operations.set_gdt_extended_options");
    ...
    [OperationImplementation("gdt_operations.get_gdt_extended_options")]
    public override Task<Api.GetGdtExtendedOptionsResult> GetGdtExtendedOptions(Api.GetGdtExtendedOptionsRequest request, ServerCallContext context) =>
        MpOperationServiceExecutor.ExecuteAsync<Api.GetGdtExtendedOptionsRequest, Api.GetGdtExtendedOptionsResult>(executor, request, context, "gdt_operations.get_gdt_extended_options");
