...
public sealed class GetWorkingDirectoryServiceTests
{
    ...
    public async Task GeneratedClientRetrievesDirectoryThroughHandwrittenBinding()
    {
        ...
        var result = await client.GetWorkingDirectoryAsync(
            new Api.GetWorkingDirectoryRequest());
    ...
    private static Api.FileOperations.FileOperationsClient CreateClient(
        IWorkerCommandExecutor executor)
    {
        var service = new FileOperationsService(new OperationExecutor(
            ...
            TimeProvider.System));
        return new Api.FileOperations.FileOperationsClient(
