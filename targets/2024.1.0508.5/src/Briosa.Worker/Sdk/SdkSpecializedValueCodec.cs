...
internal static class SdkSpecializedValueCodec
{
    ...
    public static string ToSdkString(SdkInstrumentTypeValue value) => value switch
    {
        ...
        SdkInstrumentTypeValue.PmtArm4m7Dof => "PMT Arm 4m 7 dof",
        SdkInstrumentTypeValue.ScAlertTemperatureProbe => "ScAlert Temperature Probe",
    ...
    public static string ToSdkString(SdkCompTechniqueValue value) => value switch { SdkCompTechniqueValue.Standard => "Standard", SdkCompTechniqueValue.MaxInscribed => "Max Inscribed", SdkCompTechniqueValue.MinCircumscribed => "Min Circumscribed", _ => throw Unknown(value) };
    public static string ToSdkString(SdkDegreeOfFreedomValue value) => value switch { SdkDegreeOfFreedomValue.Any => "Any", SdkDegreeOfFreedomValue.LockFocusLocation => "Lock Focus Location", SdkDegreeOfFreedomValue.LockVertexLocation => "Lock Vertex Location", _ => throw Unknown(value) };
    public static string ToSdkString(SdkFitMethodValue value) => value switch { SdkFitMethodValue.MinimumRms => "Minimum RMS", SdkFitMethodValue.BestAxis => "Best Axis", _ => throw Unknown(value) };
    public static string ToSdkString(SdkMeasuredSideForPlanarOffsetValue value) => value switch { SdkMeasuredSideForPlanarOffsetValue.AbovePlane => "Above Plane", SdkMeasuredSideForPlanarOffsetValue.ProbeCenter => "Probe Center", SdkMeasuredSideForPlanarOffsetValue.BelowPlane => "Below Plane", _ => throw Unknown(value) };
    public static string ToSdkString(SdkMeasuredSideForRadialOffsetValue value) => value switch { SdkMeasuredSideForRadialOffsetValue.Inside => "Inside", SdkMeasuredSideForRadialOffsetValue.ProbeCenter => "Probe Center", SdkMeasuredSideForRadialOffsetValue.Outside => "Outside", _ => throw Unknown(value) };
    public static string ToSdkString(SdkMpDialogInteractionModeValue value) => value switch { SdkMpDialogInteractionModeValue.BlockApplicationInteraction => "Block Application Interaction", SdkMpDialogInteractionModeValue.AllowApplicationInteraction => "Allow Application Interaction", _ => throw Unknown(value) };
    public static string ToSdkString(SdkMpInteractionModeValue value) => value switch { SdkMpInteractionModeValue.HaltOnFailureOnly => "Halt on Failure Only", SdkMpInteractionModeValue.HaltOnFailureOrPartialSuccess => "Halt on Failure or Partial Success", SdkMpInteractionModeValue.NeverHalt => "Never Halt", _ => throw Unknown(value) };
    public static string ToSdkString(SdkNormalDirectionValue value) => value switch { SdkNormalDirectionValue.ProbingDirection => "Probing Direction", SdkNormalDirectionValue.WorkingOriginPositive => "Working Origin Positive", SdkNormalDirectionValue.RightHandRule => "Right Hand Rule", _ => throw Unknown(value) };
    public static string ToSdkString(SdkSaInteractionModeValue value) => value switch { SdkSaInteractionModeValue.Manual => "Manual", SdkSaInteractionModeValue.Automatic => "Automatic", SdkSaInteractionModeValue.Silent => "Silent", _ => throw Unknown(value) };
