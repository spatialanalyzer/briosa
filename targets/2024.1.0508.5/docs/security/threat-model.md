...
This threat model covers the public gRPC host, development-only gRPC reflection, disposable SDK worker, SpatialAnalyzer SDK connection, handwritten read-only operations, packaging, and operator configuration for exact target SA 2024.1.0508.5.
