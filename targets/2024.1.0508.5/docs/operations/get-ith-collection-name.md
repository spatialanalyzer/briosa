...
`GetIthCollectionName` implements the SpatialAnalyzer MP command `Get i-th Collection Name` for exact target `2024.1.0508.5`. Its naming deliberately stays recognizable to developers who already program MPs.
