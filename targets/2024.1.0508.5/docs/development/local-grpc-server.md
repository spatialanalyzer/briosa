...
- Install and license SpatialAnalyzer 2024.1.0508.5 and its matching SDK
...
Run commands below from `targets/2024.1.0508.5`. A locked restore is a useful
...
```powershell
dotnet user-secrets set "Briosa:SpatialAnalyzer:Identity:ActivatedSdk:OperatorAttestation:Version" "2024.1.0508.5" --project src/Briosa.Server
...
dotnet user-secrets set "Briosa:SpatialAnalyzer:Identity:ConnectedSpatialAnalyzer:OperatorAttestation:Version" "2024.1.0508.5" --project src/Briosa.Server
