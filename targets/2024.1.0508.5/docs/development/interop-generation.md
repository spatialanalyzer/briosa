...
Open **Visual Studio 2026 Developer PowerShell**, change to `targets/2024.1.0508.5`, and run:

```powershell
.\eng\Generate-SpatialAnalyzerInterop.ps1 `
  -TypeLibraryPath 'C:\Program Files (x86)\New River Kinematics\SpatialAnalyzer 2024.1.0508.5\SpatialAnalyzerSDK.exe' `
  -SpatialAnalyzerVersion '2024.1.0508.5'
```
