...
The [2024 validation record](../docs/development/sa2024-compatibility.md)
distinguishes portable verification from the unexecuted licensed scenarios.
...
- Windows x64;
- a separately installed and licensed SpatialAnalyzer `2024.1.0508.5`;
...
`Test-LocalLicensedLifecycle.ps1` is an opt-in lifecycle suite. It has not been
executed against this target; see the [validation record](../docs/development/sa2024-compatibility.md).
The [instrument scenarios](../docs/operations/legacy-instruments.md) are separately
opt-in and require approved hardware fixtures.
