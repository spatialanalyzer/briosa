    ...
    private const string SyntheticOperation = """
        {
          ...
          "arguments": [
            { "argument_id": "enabled", "ordinal": 0, "mp_name": "Enabled", "direction": "input", "result_only": "no", "semantic_type": "logical", "input": { "presence": "required", "omission_behavior": "reject_request", "default": { "status": "none" } }, "sdk_binding": { "status": "available", "setter": "SetBoolArg", "getter": null }, "documentation": "Required logical input." },
            { "argument_id": "optional_count", "ordinal": 1, "mp_name": "Optional Count", "direction": "input", "result_only": "no", "semantic_type": "whole_number", "input": { "presence": "optional", "omission_behavior": "omit_sdk_setter", "default": { "status": "none" } }, "sdk_binding": { "status": "available", "setter": "SetIntegerArg", "getter": null }, "documentation": "Optional integer input." },
            { "argument_id": "threshold", "ordinal": 2, "mp_name": "Threshold", "direction": "input", "result_only": "no", "semantic_type": "floating_point", "input": { "presence": "optional", "omission_behavior": "set_catalog_default", "default": { "status": "reviewed", "value": 1.5 } }, "sdk_binding": { "status": "available", "setter": "SetDoubleArg", "getter": null }, "documentation": "Reviewed-default floating input." },
            { "argument_id": "label", "ordinal": 3, "mp_name": "Label", "direction": "input_output", "result_only": "no", "semantic_type": "string", "input": { "presence": "required", "omission_behavior": "reject_request", "default": { "status": "none" } }, "sdk_binding": { "status": "available", "setter": "SetStringArg", "getter": "GetStringArg" }, "documentation": "String input and output." },
            { "argument_id": "point", "ordinal": 4, "mp_name": "Point", "direction": "input_output", "result_only": "no", "semantic_type": "point_name", "input": { "presence": "optional", "omission_behavior": "omit_sdk_setter", "default": { "status": "none" } }, "sdk_binding": { "status": "available", "setter": "SetPointNameArg", "getter": "GetPointNameArg" }, "documentation": "Point name input and output." },
            { "argument_id": "vector", "ordinal": 5, "mp_name": "Vector", "direction": "input_output", "result_only": "no", "semantic_type": "vector", "input": { "presence": "required", "omission_behavior": "reject_request", "default": { "status": "none" } }, "sdk_binding": { "status": "available", "setter": "SetVectorArg", "getter": "GetVectorArg" }, "documentation": "Vector input and output." },
            { "argument_id": "tolerances", "ordinal": 6, "mp_name": "Tolerances", "direction": "input_output", "result_only": "no", "semantic_type": "tolerance_vector_options", "input": { "presence": "required", "omission_behavior": "reject_request", "default": { "status": "none" } }, "sdk_binding": { "status": "available", "setter": "SetToleranceVectorOptionsArg", "getter": "GetToleranceVectorOptionsArg" }, "documentation": "Tolerance input and output." },
            { "argument_id": "logical_result", "ordinal": 7, "mp_name": "Logical Result", "direction": "output", "result_only": "yes", "semantic_type": "logical", "sdk_binding": { "status": "available", "setter": null, "getter": "GetBoolArg" }, "documentation": "Logical result." },
            { "argument_id": "integer_result", "ordinal": 8, "mp_name": "Integer Result", "direction": "output", "result_only": "yes", "semantic_type": "whole_number", "sdk_binding": { "status": "available", "setter": null, "getter": "GetIntegerArg" }, "documentation": "Integer result." },
            { "argument_id": "double_result", "ordinal": 9, "mp_name": "Double Result", "direction": "output", "result_only": "yes", "semantic_type": "floating_point", "sdk_binding": { "status": "available", "setter": null, "getter": "GetDoubleArg" }, "documentation": "Floating result." }
          ],
