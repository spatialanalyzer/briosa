...
| `GetFitConstraintScalarOptionsArg` | `getter` | `inventory_and_interop` | `usable` | `fit_constraint_scalar_options` | `planned` | `planned` | `planned` | `planned` | `planned` | 2 | 1 | 1 | boolean (value string argName, ref boolean bUseHigh, ref double highTol, ref boolean bUseLow, ref double lowTol) |  |
...
| `GetIntegerArg` | `getter` | `inventory_and_interop` | `usable` | `whole_number` | `implemented` | `implemented` | `implemented` | `implemented` | `implemented` | 88 | 40 | 48 | boolean (value string argName, ref int32 value) |  |
...
| `GetSigmoidalGapConstraintOptionsArg` | `getter` | `inventory_only` | `blocked_missing_interop` | `sigmoidal_gap_constraint_options` | `blocked` | `blocked` | `blocked` | `blocked` | `blocked` | 2 | 1 | 1 | not present in interop | https://github.com/spatialanalyzer/briosa/issues/53 |
| `GetStringArg` | `getter` | `inventory_and_interop` | `usable` | `string` | `implemented` | `implemented` | `implemented` | `implemented` | `implemented` | 76 | 39 | 37 | boolean (value string argName, ref string value) |  |
...
| `GetVectorArg` | `getter` | `inventory_and_interop` | `usable` | `vector3` | `implemented` | `implemented` | `implemented` | `implemented` | `implemented` | 42 | 15 | 27 | boolean (value string argName, ref double XValue, ref double yValue, ref double zValue) |  |
...
| `SetBoolArg` | `setter` | `inventory_and_interop` | `usable` | `logical` | `implemented` | `implemented` | `implemented` | `implemented` | `implemented` | 378 | 67 | 311 | boolean (value string argName, value boolean value) |  |
...
| `SetColInstIdArg` | `setter` | `inventory_and_interop` | `usable` | `collection_instrument_id` | `planned` | `planned` | `planned` | `planned` | `planned` | 149 | 16 | 133 | boolean (value string argName, value string collectionName, value int32 instId) |  |
...
| `SetCollectionObjectNameArg2` | `setter` | `inventory_and_interop` | `usable` | `collection_object_name` | `planned` | `planned` | `planned` | `planned` | `planned` | 480 | 21 | 459 | boolean (value string argName, value string collectionName, value string objectName, value string objectType) |  |
| `SetCollectionObjectNameRefListArg` | `setter` | `inventory_and_interop` | `usable` | `collection_object_name_list` | `planned` | `planned` | `planned` | `planned` | `planned` | 187 | 32 | 155 | boolean (value string argName, ref object objectNameList) |  |
...
| `SetColorArg` | `setter` | `inventory_and_interop` | `usable` | `rgb_color` | `planned` | `planned` | `planned` | `planned` | `planned` | 13 | 3 | 10 | boolean (value string argName, value byte redColorVal, value byte greenColorVal, value byte blueColorVal) |  |
...
| `SetCoordinateSystemTypeArg` | `setter` | `inventory_and_interop` | `usable` | `coordinate_system_type` | `planned` | `planned` | `planned` | `planned` | `planned` | 7 | 1 | 6 | boolean (value string argName, value string coordSystemType) |  |
...
| `SetDoubleArg` | `setter` | `inventory_and_interop` | `usable` | `floating_point` | `implemented` | `implemented` | `implemented` | `implemented` | `implemented` | 226 | 50 | 176 | boolean (value string argName, value double value) |  |
...
| `SetFilePathArg` | `setter` | `inventory_and_interop` | `usable` | `file_reference` | `planned` | `planned` | `planned` | `planned` | `planned` | 120 | 17 | 103 | boolean (value string argName, value string path, value boolean embeddedFile) |  |
...
| `SetFontTypeArg` | `setter` | `inventory_and_interop` | `usable` | `font` | `planned` | `planned` | `planned` | `planned` | `planned` | 21 | 12 | 9 | boolean (value string argName, value string fontName, value byte fontSize, value byte redColorVal, value byte greenColorVal, value byte blueColorVal) |  |
...
| `SetIntegerArg` | `setter` | `inventory_and_interop` | `usable` | `whole_number` | `implemented` | `implemented` | `implemented` | `implemented` | `implemented` | 243 | 106 | 137 | boolean (value string argName, value int32 value) |  |
...
| `SetStringArg` | `setter` | `inventory_and_interop` | `usable` | `string` | `implemented` | `implemented` | `implemented` | `implemented` | `implemented` | 367 | 171 | 196 | boolean (value string argName, value string value) |  |
...
| `SetUdpTransmitSettingsArg` | `setter` | `inventory_and_interop` | `usable` | `udp_transmit_settings` | `planned` | `planned` | `planned` | `planned` | `planned` | 2 | 1 | 1 | boolean (value string argName, value boolean bEnabled, value boolean bBroadcast, value string compName, value int32 port) |  |
